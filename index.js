  ...
  `<div class="clients-grid">${clientList.map(c => `
    <div class="client-card">
      <form method="POST" action="/admin/delete" style="display:inline">
        ...
        <input type="hidden" name="password" value="${req.query.p || ''}">
        <a href="/admin/edit?p=${req.query.p || ''}&id=${c.id}" style="position:absolute;top:16px;right:100px;background:rgba(77,166,255,0.1);border:1px solid rgba(77,166,255,0.2);color:#4da6ff;border-radius:8px;padding:6px 12px;font-size:12px;text-decoration:none;font-family:inherit">Edit</a>
