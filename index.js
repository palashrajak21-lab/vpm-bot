...
Choose the best post type automatically:
1. NEWS POST: current events/war/sports results/market news → summarize with business lesson angle
2. TOOLS POST: tools/apps/software → list real tool names
3. TRENDING: movie/celeb/event → connect creatively to business or AI
4. QUOTE: famous person → use their real quote
5. MOTIVATIONAL: mindset/hustle → bold statement
