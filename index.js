  ...
  `<div class="clients-grid">${clientList.map(c => `
    <div class="client-card">
      <form method="POST" action="/admin/delete" style="display:inline">
        ...
        <a href="/admin/exchange-token?p=${req.query.p || ''}&id=${c.id}" onclick="return confirm('Exchange Instagram token for ${c.name}? Make sure you have pasted a fresh short-lived token in Edit first!')" style="position:absolute;top:16px;right:90px;background:rgba(0,186,124,0.1);border:1px solid rgba(0,186,124,0.2);color:#00ba7c;border-radius:8px;padding:6px 12px;font-size:12px;text-decoration:none;font-family:inherit">🔄 Exchange Token</a>
